	...
	<div class="header">
		...
		<div class="wrap" style="margin-left: 12%;">
			<div class="header_top">
				<div class="logo">
					<div class="titlenaranhi">
						<a href="homeButton"><img class="titleimage"
							src="./assets/images/main logo.jpg"></a>
					</div>
					<div class="titlenaranhi">
						<h1>
							<a href="homeButton" class="mainTitle"">本ーE</a>
						</h1>
					</div>
				</div>
				<div class="header_top_right">
					...
					<div class="search_box">
						<form action="searchBook">
							<!-- <<<<<<<<<<<<<<<<여기 가 검색 부분 액션 이름 단 입니다. -->
							<b><input type="text" name="bookTitle"
								placeholder="Search..." required="검색어를 입력하세요...." maxlength="25"></b>
			...
			<div class="header_bottom" style="width: 100%;">
				...
				<div class="header_bottom_left"
					style="position: absolute; margin-left: 6%;">
					<div class="categories"
						style="margin-left: 27%; margin-right: 30%; width: 70%;">
						<ul>
							<h3>Categories</h3>
							...
							<div id="slider" class="nivoSlider"
								...
								<c:forEach var="list" items="${blist}">
									<a href="BookForm?isbn=${list.isbn}"> <img
										src="${list.image}" alt="すみませんが、準備しています。"
										style="width: 520px; height: 610px;">
									</a>
								</c:forEach>
	...
	<div class="main">
		<div class="wrap" style="margin-left: 12%;">
			<div class="content">
				<div class="content_top">
					<div class="heading">
						<h3 style="font-weight: 600;">
							Search Result : <font
								style="font-weight: 900; font-size: 27px; color: #1000ff;">${total}個</font>
						</h3>
					</div>
				</div>
				<!-- ------------------------------------------------------ 1번째줄 start------------------------------------------------   --->
				<div class="section group">
					...
					<div class="listDiv" style="margin-right: -3%; margin-left: 2%;">
						<c:forEach var="list" items="${blist}">
							<div class="grid_1_of_5 images_1_of_5"
								style="height: 375px; box-shadow: 4px 3px 3px rgba(189, 149, 4, 0.53); border: 1px solid #ff8e01; margin-right: 10px;">
									...
									<div class="explain2">
										...
										<h2 class="explain3">
											<a href="BookForm?isbn=${list.isbn}"
												class="searchBookLiskTitle" style="width: 100%;">${list.title}</a>
										</h2>
										<p class="explain4">
											<font style="color: black; font-weight: bold;">${list.title}</font>
										</p>
									</div>
								</div>
								<div class="price-details">
									<div class="price-number">
										<span class="rupees1">&#8361;${list.price}</span><font
											style="font-size: 20px; font-weight: 700;"> > </font> <font
											style="font-size: 21px;">&#8361;</font><span class="rupees2">${list.discount}</span>
									</div>
									<div class="add-cart1" style="margin-left: 0%;">
										<div class="clickku"
											style="cursor: pointer; position: absolute; width: 35%;"
											id="${list.isbn}">
											<a style="color: aliceblue;"><font
												style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">Add
													to Cart</font></a>
										</div>
										<div class="clickku1"
											style="cursor: pointer; position: absolute; width: 36%; margin-left: 46%;"
											id="${list.isbn}">
											<a style="color: aliceblue; cursor: pointer"><font
												style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">PurChase</font></a>
										</div>
					...
					<div class="pagingForm">
						<a
							href="javascript:pagingFormSubmit(${pagenaviga.currentPage - pagenaviga.pagePerGroup})">◁◁
						</a> &nbsp;&nbsp; <a
							href="javascript:pagingFormSubmit(${pagenaviga.currentPage - 1})">◀</a>
						&nbsp;&nbsp;
            ...
            <option>출판사</option>
							...
							<input type="hidden" name="bookTitle" placeholder="검색하시오"
								value="${searchText}" /> <input type="hidden"
								onclick="pagingFormSubmit(1);" value="검색">
						</form>
					</div>
					<!-- ----------------------------------------------------------검색폼 end-------------------------------------------------- -->
				</div>
	...
	<div class="footer">
		<div class="wrap">
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<div class="social-icons">
						<h4>SUPPORT</h4>
						<ul>
							<li><a href="https://www.aladin.co.kr/home/welcome.aspx"
								target="_blank"><img class="iconkugi"
									src="./BookForm/images/aladin.png" /></a></li>
							<li><a href="http://www.kyobobook.co.kr/index.laf?OV_REFFER"
								target="_blank"><img class="iconkugi"
									src="./BookForm/images/kyobo.jpg" /></a></li>
							<li><a href="https://book.naver.com" target="_blank"><img
									class="iconkugi" src="./BookForm/images/naver.ico" /></a></li>
							<li><a href="http://www.yes24.com/main/default.aspx"
								target="_blank"><img class="iconkugi"
									src="./BookForm/images/yes24.png" /></a></li>
						</ul>
						<div class="clear"></div>
					</div>
				</div>
			...
			<div class="copy_right">
				<p>
					Company Name © All rights Reseverd | Design by <font
						style="color: #ff8600">Jeon Jae Hyoung</font>
				</p>
			</div>
		</div>
	</div>
