...
var Contents = function () {
	function Contents(doc, content, cfiBase, sectionIndex) {
		...
		this.listeners();
		console.log('doc : ' + this.document.body);
 ...
 */
var Layout = function () {
	console.log('starting point of Layout');
...
var _createClass = function () {
	console.log('_createClass about font');
	function defineProperties(target, props) {
		for (var i = 0; i < props.length; i++) {
	...
	return function (Constructor, protoProps, staticProps) {
		console.log('_createClass about font return');
		if (protoProps) defineProperties(Constructor.prototype, protoProps);
		if (staticProps) defineProperties(Constructor, staticProps);
		return Constructor;
	};
...
var Themes = function () {
	...
	function Themes(rendition) {
		...
		//this.rendition.hooks.content.register(this.fontSize.bind(15));
		//this.rendition.hooks.content.register(this.override.bind("font-size",20));
	}
  ...
  */
   ...
   */
		...
		value: function fontSize(size) {
			...
			this._overrides["font-size"] = size;

			contents.forEach(function (content) {
				content.css("font-size", _this2._overrides["font-size"]);
			})*/
